  ...
  <div class="no-find">
    <div class="wscn-http404">
      ...
      <div class="text-404">
        ...
        <div class="text-404__info">Please check that the URL you entered is correct, or click the button below to return
          to the homepage.</div>
...
import image404cloud from '@/assets/common/404-cloud.png'
